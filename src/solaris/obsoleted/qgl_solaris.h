...
#define qgl3DfxSetPaletteEXT gl3DfxSetPaletteEXT


/* nonexistent functions */
typedef void *VoidFunc();
static VoidFunc *qglColorTableEXT = NULL;
static VoidFunc *qglSelectTextureSGIS = NULL;
static VoidFunc *qglActiveTextureARB = NULL;
static VoidFunc *qglClientActiveTextureARB = NULL;
static VoidFunc *qglLockArraysEXT = NULL;
static VoidFunc *qglUnlockArraysEXT = NULL;
static VoidFunc *qglMTexCoord2fSGIS = NULL;
static VoidFunc *qglPointParameterfEXT = NULL;
static VoidFunc *qglPointParameterfvEXT = NULL;
